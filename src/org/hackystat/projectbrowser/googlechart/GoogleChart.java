...
public class GoogleChart {
  ...
  public static void main(String[] args) {
    GoogleChart chart = new GoogleChart(ChartType.HORIZONTAL_SERIES_BAR, 300, 1000, new ArrayList<List<Double>>());
  ...
  public String getUrl() {
    ...
    if (chartDataScale != null && chartDataScale.size() > 0) {
  ...
  private String getColorDataAsString(List<Color> colorList) {
    ...
    for (Color color : colorList) {
      colorString += colorToString(color) + DATAITEM_SEPARATOR;
    }
  ...
  private String colorToString(Color color) {
    ...
    String green = "000" + Integer.toHexString(color.getGreen());
    String blue = "000" + Integer.toHexString(color.getBlue());
    String alpha = "000" + Integer.toHexString(color.getAlpha());
  ...
  private String getDataAsString(List<List<Double>> list) {
    ...
    for (List<Double> dataList : list) {
      dataString += toTextEncodingData(dataList) + DATASET_SEPARATOR;
    }
  ...
  private String toTextEncodingData(List<Double> dataList) {
    ...
    for (Double dataItem : dataList) {
      dataString += dataItem + DATAITEM_SEPARATOR;
    }
