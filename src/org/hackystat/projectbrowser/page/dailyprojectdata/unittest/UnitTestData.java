 ...
 */
public class UnitTestData implements Serializable {
   ...
   */
  public UnitTestData(Project name) {
    this.project = name;
    for (int i = 0; i < 2; i++) {
      buckets.add(0);
    }
  ...
  /**
   * Updates this UnitTestData instance with information about the numbers of passes and failures
